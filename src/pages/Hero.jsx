...
function Hero() {
  ...
  return (
    <div className='p-5 flex flex-col items-center justify-center min-h-screen'>
      <p className='w-full md:w-[80%] p-5 text-lg md:text-xl '>
      ...
      <div className='relative text-4xl md:text-6xl lg:text-8xl w-full md:w-[80%] text-center'>
        ...
        >
          <img src={me} alt="me" className='m-auto drop-shadow-lg  md:w-64 lg:w-80' />
        </div>
        <h2 className='font-[Oakside] text-center'>developer</h2>
      </div>
      <p className='p-5 w-full md:w-[80%] text-lg md:text-xl text-end'>📍 Based in Casablanca, Morocco 🇲🇦.</p>
    </div>
  );
}
